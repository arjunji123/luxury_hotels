...
const LuxuryHotelResort = () => {
  ...
  return (
    <>
      ...
      <div className="">
        <div
          className="whater-effect hotel-cards-container section-padding"
        ...
        >
          {allHotels?.hotels?.map((hotel, index) => (
            ...
            <div className="hotel-cards" key={index}>
              ...
              <div className="hotel-content flex flex-col flex-grow justify-between ">
                <button
                  onClick={() => handleNavigate(hotel?.slug)}
                  className="bg-white text-[#846316] px-3 py-2 rounded-md uppercase w-full min-h-[50px] flex items-center justify-center"
                >
                  {hotel?.hotel_name?.toUpperCase()}
                </button>

                <button className="bg-[#846316] text-white px-3 py-2 rounded-md uppercase w-full min-h-[50px] flex items-center justify-center mt-2">
                  {hotel?.country?.country || "Unknown Country"}
                </button>
              </div>
            </div>

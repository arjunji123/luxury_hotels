...
const BrandSection = () => {
    const brandImg = [
        ...
        { img: '/new/assets/img/the-luxury-collection.png', name: 'The Luxury Collection' },
                ...
                >
                    {brandImg.map((hotel, index) => (
                        <SwiperSlide className='p-2' key={index}>
                            ...
                            <div className="mx-auto brand-logos" tabIndex="-1" style={{ width: " 100%", display: "inline-block" }}>

                                <img className="partners-logo p-3 " src={hotel.img} alt={hotel.name} />
                            </div>
                            {/* </div>
                            </div> */}
                        </SwiperSlide>
